...
>
        ...
        />
                             ...
                             <Layout.Col span={5}>
                               <Form.Item label='商品货号' prop='seller_outer_no'>
                                 <Input value={seller_outer_no || ''} onKeyUp={(e) => { if (e.keyCode == 13) return onSearch() }}
                                   onChange={onValueChange.bind(this, 'seller_outer_no')}
         />
                               </Form.Item>
                             </Layout.Col>
                             <Layout.Col span={5}>
         ...
         />
                             ...
                             <Layout.Col span={5}>
                               <Form.Item label='颜色' prop='color_type'>
                                 <Input value={color_type || ''} onKeyUp={(e) => { if (e.keyCode == 13) return onSearch() }}
                                   onChange={onValueChange.bind(this, 'color_type')}
         />
                               </Form.Item>
                             </Layout.Col>
                             <Layout.Col span={5}>
                               <Form.Item label='尺码' prop='size_type'>
                                 <Input type='text' value={size_type || ''} onKeyUp={(e) => { if (e.keyCode == 13) return onSearch() }}
                                   onChange={onValueChange.bind(this, 'size_type')}
        />
                               </Form.Item>
                             </Layout.Col>
                             <Layout.Col span={5}>
