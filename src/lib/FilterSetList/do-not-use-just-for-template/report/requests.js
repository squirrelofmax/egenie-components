...
exports.getGoodsCategory = exports.getVendorDict = exports.getWarehouse = exports.queryDetailOfProduct = exports.queryByProduct = exports.getTotalNums = exports.getList = exports.getPurchaseOrderById = exports.deletePurchaseOrder = exports.createStockInOrder = exports.closePurchaseOrder = exports.publishPurchaseOrder = exports.recheckPurchaseOrder = exports.checkPurchaseOrder = exports.getDictsByTypes = exports.updateSaleOrderDetail = exports.getSaleOrderLogList = exports.deleteScheme = exports.getConfig = exports.saveAsNewFilterset = undefined;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            url = '/api/filterSet2/save/ReportGoodsStats';
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            url = '/api/filterSet2/getConfig2?dictList=&itemList=vendor,organization&module=ReportGoodsStats';
            _context2.next = 4;
            return (0, _egFetch2.default)(url, myInit);
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            url = '/api/filterSet/filterSets/' + name + '/ReportGoodsStats';
            _context3.next = 4;
            return (0, _egFetch2.default)(url, myInit);
...
var getSaleOrderLogList = exports.getSaleOrderLogList = function () {
  var _ref4 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee4(pid, data) {
    var myInit, url, response, result;
  ...
  return function getSaleOrderLogList(_x3, _x4) {
    return _ref4.apply(this, arguments);
  };
}();

var updateSaleOrderDetail = exports.updateSaleOrderDetail = function () {
  var _ref5 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee5(data, id) {
    var obj, myInit, url, response, result;
...
var getDictsByTypes = exports.getDictsByTypes = function () {
  ...
  return function getDictsByTypes(_x7) {
...
var checkPurchaseOrder = exports.checkPurchaseOrder = function () {
  ...
  return function checkPurchaseOrder(_x8) {
...
var recheckPurchaseOrder = exports.recheckPurchaseOrder = function () {
  ...
  return function recheckPurchaseOrder(_x9) {
...
var publishPurchaseOrder = exports.publishPurchaseOrder = function () {
  ...
  return function publishPurchaseOrder(_x10) {
...
var closePurchaseOrder = exports.closePurchaseOrder = function () {
  ...
  return function closePurchaseOrder(_x11) {
...
var createStockInOrder = exports.createStockInOrder = function () {
  ...
  return function createStockInOrder(_x12) {
...
var deletePurchaseOrder = exports.deletePurchaseOrder = function () {
  ...
  return function deletePurchaseOrder(_x13) {
...
var getPurchaseOrderById = exports.getPurchaseOrderById = function () {
  ...
  return function getPurchaseOrderById(_x14) {
...
var getList = exports.getList = function () {
      ...
      while (1) {
        switch (_context14.prev = _context14.next) {
          case 0:
            ...
            url = '/api/productStatisticsController/getDetailNums';
            _context14.next = 4;
            return (0, _egFetch2.default)(url, myInit);

          case 4:
            response = _context14.sent;
            result = response || { status: 'Failed', data: '网络错误：获取商品汇总表格数据失败，请联系管理员！' };
  ...
  return function getList(_x15) {
    return _ref14.apply(this, arguments);
  };
}();

var getTotalNums = exports.getTotalNums = function () {
      ...
      while (1) {
        switch (_context15.prev = _context15.next) {
          case 0:
            ...
            url = '/api/productStatisticsController/getTotalNums';
            _context15.next = 4;
            return (0, _egFetch2.default)(url, myInit);

          case 4:
            response = _context15.sent;
            result = response || { status: 'Failed', data: '网络错误：获取商品汇总信息失败，请联系管理员！' };
  ...
  return function getTotalNums(_x16) {
...
var queryByProduct = exports.queryByProduct = function () {
  ...
  return function queryByProduct(_x17) {
    return _ref16.apply(this, arguments);
  };
}();

var queryDetailOfProduct = exports.queryDetailOfProduct = function () {
  var _ref17 = (0, _asyncToGenerator3.default)( /*#__PURE__*/_regenerator2.default.mark(function _callee17(id, wid) {
    var myInit, url, response, result;
  ...
  return function queryDetailOfProduct(_x18, _x19) {
...
var getWarehouse = exports.getWarehouse = function () {
  ...
  return function getWarehouse(_x20) {
...
var getVendorDict = exports.getVendorDict = function () {
  ...
  return function getVendorDict(_x21) {
...
var getGoodsCategory = exports.getGoodsCategory = function () {
  ...
  return function getGoodsCategory(_x22) {
