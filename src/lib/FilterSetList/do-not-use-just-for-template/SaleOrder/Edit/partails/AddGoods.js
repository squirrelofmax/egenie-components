...
var Header = (0, _mobxReact.observer)(function (_ref) {
  var _ref$store = _ref.store,
      ...
      product_seller_outer_no = _ref$store$searchObj$.product_seller_outer_no,
      sku_no = _ref$store$searchObj$.sku_no,
      vendor_name = _ref$store$searchObj$.vendor_name,
      bar_code = _ref$store$searchObj$.bar_code,
      color = _ref$store$searchObj$.color,
      size = _ref$store$searchObj$.size,
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          _elementReact.Form.Item,
          { label: '\u5546\u54C1\u8D27\u53F7', prop: 'product_seller_outer_no' },
          _react2.default.createElement(_elementReact.Input, { value: product_seller_outer_no || '', onKeyUp: function onKeyUp(e) {
              if (e.keyCode == 13) return onSearch();
            },
            onChange: onValueChange.bind(undefined, 'product_seller_outer_no')
          })
        )
      ),
      _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          _elementReact.Form.Item,
          { label: '\u989C\u8272', prop: 'color' },
          _react2.default.createElement(_elementReact.Input, { value: color || '', onKeyUp: function onKeyUp(e) {
              if (e.keyCode == 13) return onSearch();
            },
            onChange: onValueChange.bind(undefined, 'color')
          })
        )
      ),
      _react2.default.createElement(
        ...
        _react2.default.createElement(
          _elementReact.Form.Item,
          { label: '\u5C3A\u7801', prop: 'size' },
          _react2.default.createElement(_elementReact.Input, { type: 'text', value: size || '', onKeyUp: function onKeyUp(e) {
              if (e.keyCode == 13) return onSearch();
            },
            onChange: onValueChange.bind(undefined, 'size')
          })
        )
      ),
      _react2.default.createElement(
