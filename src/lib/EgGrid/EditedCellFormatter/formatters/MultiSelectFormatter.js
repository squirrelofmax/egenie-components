...
var SelectFormatter = (0, _mobxReact.observer)(function (_ref) {
  ...
  return _react2.default.createElement(
    ...
    disabled ? (value || []).join(',') : _react2.default.createElement(
      _elementReact.Select,
      { value: value || [], clearable: clearable, filterable: filterable, multiple: true,
      ...
      options && options.length ? options.map(function (_ref2) {
        ...
        return _react2.default.createElement(_elementReact.Select.Option, { label: label, value: value, key: label });
      }) : null
    )
  );
}); // 框架
